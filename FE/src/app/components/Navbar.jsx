...
const Navbar = () => {
    ...
    const onKeyDown = (e) => {
        ...
        if(e.key === 'ArrowDown') {
            e.preventDefault()
            setActive((prev) => {
                const lastIndex = (searchResults.length ?? 0) - 1
            ...
            setActive((prev) => {
                ...
                if (lastIndex < 0) return -1   // no results
                // If nothing selected, jump to last item
                ...
                <div className="relative" ref={boxRef}>
                    ...
                    {open && query.trim().length >= 2 && (
                        ...
                        >
...

                                {
                                    ...
                                    searchResults.map((item, i) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className='mt-0.5 h-6 w-6 rounded-md border border-neutral-200 flex items-center justify-center
                                                    text-xs text-neutral-500 shrink-0'
                                                >
                                                    {i + 1}
                                                </div>
                            ...
                            <div className='px-3 py-2 text-xs text-neutral-500 border-t border-neutral-100 flex tems-center justify-between'>
                                <span> Use ↑/↓ and press enter to open</span>
                                <span className='hidden md:block'>Esc to close</span>
                            </div>              
