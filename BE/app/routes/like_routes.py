...
def like_note(note_id):
    ...
    return response_success(like, message)
...
def my_favorites():
    ...
    items, meta, message = list_my_favorites(user_id, page=page, per_page=per_page)
    return response_success(items, message, meta)